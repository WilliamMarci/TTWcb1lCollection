...
loadmodel=/eos/cms/store/cmst3/user/hqu/training/ttH/ttH_1L/ParT/20240224-162023_ParT_ranger_lr0.004_batch2048_20240224_dev_ak4puppi_pre+ttHinc+ttZEFT+ttZBB+TTbb
...
weaver --data-train \
    ...
    --data-config ${workdir}/data/ttH_1L_${model}.yaml --network-config $modelopts \
