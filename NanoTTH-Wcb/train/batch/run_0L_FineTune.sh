...
loadmodel=/eos/cms/store/cmst3/user/hqu/training/ttH/ttH_0L/ParT/20240224-162023_ParT_ranger_lr0.004_batch2048_20240224_dev_ak4puppi_pre+ttHinc+ttZEFT+ttZBB+TTbb+QCDPythia
...
model=ParT
suffix="_20240224_dev_ak4puppi_FineTune"
...
weaver --data-train \
    ...
    --data-config ${workdir}/data/ttH_0L_${model}.yaml --network-config $modelopts \
    ...
    --start-lr 1e-4 --exclude-model-weights 'fc..+' --optimizer-option lr_mult '("fc.*", 10)' --num-epochs 20 \
